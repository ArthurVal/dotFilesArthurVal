...
#+begin_src emacs-lisp
  (use-package ivy
    ...
    ;; Add recently visited files to switch buffer
    (setq ivy-use-virtual-buffers t)

    ;; Format for displaying candidate count
...
#+begin_src emacs-lisp
  (use-package projectile
    ...
    :init
    ;; FIX:
    (defalias 'projectile-global-mode 'projectile-mode)
  ...
  (use-package counsel-projectile
    ...
    ;; Default switch action to dired
